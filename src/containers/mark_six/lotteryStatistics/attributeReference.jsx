...
export default class AttributeReference extends Component {
    ...
    renderBall(list, color) {
        let ball = <div></div>;
        if (color == "红波") {
            ball = <img style={{ width: '90%' }} src="../../assets/img/lotteryResult/icon_ball_red.png" />
        } else if (color == '蓝波') {
            ball = <img style={{ width: '90%' }} src="../../assets/img/lotteryResult/icon_ball_blue.png" />
        } else if (color == '绿波') {
            ball = <img style={{ width: '90%' }} src="../../assets/img/lotteryResult/icon_ball_green.png" />
        }

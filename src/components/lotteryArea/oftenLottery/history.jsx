        ...
        return (
            <div className="wh100" style={{ fontSize: "12px" }}>
                ...
                <div className="w100 flex" style={{ height: "36px", background: '#f5f5f9' }}>
                    ...
                    <div className="h100 flex" style={{ width: "65%", flexDirection: "row" }}>
                        <div className="h100 flex-center" style={{ flex: "1" }}>万</div>
                        <div className="h100 flex-center" style={{ flex: "1" }}>十</div>
                        <div className="h100 flex-center" style={{ flex: "1" }}>百</div>
                        <div className="h100 flex-center" style={{ flex: "1" }}>千</div>
                        <div className="h100 flex-center" style={{ flex: "1" }}>个</div>
                    </div>
                </div>

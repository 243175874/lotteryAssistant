...
export default class goPicturesLibrary extends Component {
    constructor(props) {
        super(props);
    ...
    getInitializeData() {
        ...
        post(`/v1/api/article/info-tk?cate=` + this.detail_id).then(data => {
            //console.log(data);
    ...
    changePeriod(period) {
        ...
        this.getPageAllDateByIdAndPeriod(this.detail_id, period[0]);
    }

...
import { setSelectedTab, setArticleId } from '../../../redux/action'
@connect(
    ...
    { setSelectedTab, setArticleId }
)

export default class SourceBookDetail extends Component {
    constructor(props) {
        super(props);
    ...
    getAttention() {
        ...
        post(`/v1/api/article/add-collect?uid=` + this.state.extenduid).then(data => {
            ...
            if (data.code == 1002) {
                ...
                this.getDetail(this.props.articleId);
            }
        });
    }

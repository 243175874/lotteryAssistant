...
export default class DoubleLongDragon extends Component {
    ...
    statistics(data) {
        ...
        //console.log(sumBigAndSmall);
        //单双
        let sumOddAndEven = Common.setLongDragon(this.statisticsSumResoult(data, this.returnSumOddEven));
        //console.log(sumOddAndEven);
        return [...bigAndSmall, ...oddAndEven, ...dragonAndTiger, ...sumBigAndSmall, ...sumOddAndEven].sort((a, b) => Number(b.periods) - Number(a.periods));;
    }
    ...
    */
    ...
    /**
       * 统计出总和结果并返回
       * @param {开奖数据} data 
       * @param {要统计的算法函数，返回当前结果} returnValue 
       */
    ...
    statisticsDragonAndTigerResoult(data) {
        let array = []
        let list = Common.statisticsList(data, this.returnDragonAndTiger, 0, 4);
        array.push({ index: "龙虎", list });
        return array;
    }

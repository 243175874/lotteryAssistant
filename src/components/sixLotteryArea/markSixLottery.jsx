...
export default class MarkSix extends Component {
    ...
    renderBallIcon(num) {
        ...
        if (redball != null) {
            return (<img style={{ width: '85%' }} src="../../assets/img/lotteryResult/icon_ball_red.png" />);
        }
        if (blueball != null) {
            return (<img style={{ width: '85%' }} src="../../assets/img/lotteryResult/icon_ball_blue.png" />);
        }
        if (greenball != null) {
            return (<img style={{ width: '85%' }} src="../../assets/img/lotteryResult/icon_ball_green.png" />);
        }
    }
                    ...
                    return index != 6 ?
                        ...
                        <div key={index} className="h100  flex-center" style={{ width: "24%" }}>
                            <div className="h100 flex-center" style={{ width: '50%', marginLeft: '2%' }}>
                                <img className="w33" src="../../assets/img/lotteryResult/icon_add.png" />
                            </div>

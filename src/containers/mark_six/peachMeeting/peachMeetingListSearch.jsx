...
import { setSixUserId, setIsShowSendMessagePage, setArticleId } from '../../../redux/action'
@connect(
    state => ({ sixTitle: state.sixTitle, sixTypeId: state.sixTypeId }),
    { setSixUserId, setIsShowSendMessagePage, setArticleId }
)
...
export default class PeachMeetingList extends Component {
    ...
    getList(keyword, page) {
        ...
        post(`/v1/api/article/search?cate=331&keyword=${keyword}`, { page }).then(data => {
            if (data.code == 200) {
